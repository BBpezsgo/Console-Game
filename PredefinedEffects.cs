...
public static class PredefinedEffects
{
    public static ParticlesConfig Stuff => new()
    {
        ...
        Gradients = ImmutableArray.Create(
            new Gradient(ColorF.White, ColorF.Red)
        ),
        ParticleCount = (1, 3),
        ParticleSpeed = (4, 7),
    ...
    {
        Gradients = ImmutableArray.Create(
            new Gradient(new ColorF(1f, 1f, 1f), new ColorF(1f, .8f, 0f))
        ),
        ParticleCount = 5,
    ...
    {
        Gradients = ImmutableArray.Create(
            new Gradient(ColorF.White, ColorF.Yellow)
        ),
        ParticleCount = 5,
        ParticleLifetime = .5f,
        ParticleSpeed = (0f, 10f),
    ...
    {
        Gradients = ImmutableArray.Create(
            new Gradient(ColorF.Red, ColorF.Red * .5f)
        ),
        ParticleCount = 10,
        ParticleLifetime = 1,
        ParticleSpeed = (5, 10),
