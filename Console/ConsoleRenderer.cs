...
public class ConsoleRenderer : Win32.Console.ConsoleRenderer
{
    bool shouldResize;
    ...
    public ref ConsoleChar this[Vector2Int screenPosition] => ref base[(screenPosition.Y * Width) + screenPosition.X];
