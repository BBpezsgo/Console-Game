...
namespace ConsoleGame
{
    ...
    public class ConsoleRenderer : Win32.Utilities.ConsoleRenderer
    {
        ...
        public void FillTriangle(
            ...
            => this.FillTriangle(
                triangle.PointA.X, triangle.PointA.Y,
                triangle.TexA.X, triangle.TexA.Y, triangle.TexA.Z,
                triangle.PointB.X, triangle.PointB.Y,
                triangle.TexB.X, triangle.TexB.Y, triangle.TexB.Z,
                triangle.PointC.X, triangle.PointC.Y,
                triangle.TexC.X, triangle.TexC.Y, triangle.TexC.Z,
                image
                );
        */
